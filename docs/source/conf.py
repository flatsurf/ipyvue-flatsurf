...
# -*- coding: utf-8 -*-
#
# flatsurf_widgets documentation build configuration file
#
...
_version_py = os.path.join(repo, 'flatsurf_widgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'flatsurf_widgetsdoc'
...
latex_documents = [
    (master_doc, 'flatsurf_widgets.tex', 'flatsurf_widgets Documentation',
     'Julian Rüth', 'manual'),
]
...
man_pages = [
    (master_doc,
    'flatsurf_widgets',
    'flatsurf_widgets Documentation',
     [author], 1)
]
